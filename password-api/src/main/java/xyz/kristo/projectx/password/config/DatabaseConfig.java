package xyz.kristo.projectx.password.config;
...
import xyz.kristo.projectx.password.util.JdbcUrlConverter;

import javax.sql.DataSource;

@Configuration
@MapperScan(basePackages = {"xyz.kristo.projectx.password.dao"})
